...
<html>
    ...
    <body style="background-color:#e4e4e4;">
        <?php
        session_start();
        if(!isset($_SESSION['gid']) or (!isset($_SESSION['rs']) or $_SESSION['rs'] == 1)) {
        ...
        <div class="container">
            ...
            <?php
            session_start();
            if(!isset($_SESSION['gid']) and (!isset($_SESSION['rs']))) {
            ...
            <div class="signupform" style="background-color : white; border-radius: 4px; box-shadow: 3px 3px 3px 3px gray; padding: 2em 2em 2em 2em; margin-top : 0.8em;">
                ...
                <form action="https://blacklamp.lampstudio.xyz/editing" method="POST">
                    <p style="padding: 0.7em 0 1em 0;">
                    수정할 내용이 없다면 공백으로 두세요.
                    </p>
                    <br>
                    ...
                    <button type="submit" class="btn btn-outline-primary btn-lg btn-block">수정</button>
